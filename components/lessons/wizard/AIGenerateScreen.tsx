    ...
    <main className="px-4 pb-8">
      <div className="mx-auto w-full max-w-4xl">
        <DiscoveryShell
          ...
          subtitle="Describe your lesson topic and we&apos;ll create a complete plan."
          action={
            <button
              type="button"
              onClick={onBack}
              className="rounded-lg border border-white/30 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          {remainingRequests !== null && (
            <div id={remainsId} className="text-xs">
              {remainingRequests === 0 ? (
                ...
                <p className="text-muted">{remainingRequests} / 10 requests remaining today</p>
              )}
            </div>
          )}
