...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto py-12 space-y-10">
      <div>
        <h1 className="text-3xl font-bold text-foreground">About VistaTeacher</h1>
        <p className="mt-3 text-muted text-base leading-relaxed">
          VistaTeacher is the central hub for educators to connect, collaborate, and grow professionally. We believe great teachers deserve a great community.
        </p>
      </div>
