...
const CATEGORY_COLOR: Record<InspirationCategory, string> = {
  ...
  "education-news": "bg-accent-100 text-accent-700",
  ...
  return (
    <div className="space-y-6">
      <DiscoveryShell
        ...
        subtitle="Curated podcasts, articles, videos, and stories to inspire your teaching."
        action={
          user ? (
            ...
            <Button variant="outline" onClick={() => router.push("/auth/login?redirect=/inspiration/new")}>Sign In to Submit</Button>
          )
        }
        controls={
